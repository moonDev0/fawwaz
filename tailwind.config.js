...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'hero':"url('../public/assets/homeslide3-1-1024x499-two (1).png')",
        'header':"url('../public/assets/header.webp')",
        'counselling':"url('../public/assets/conselling-fund.webp')",
        'testimonial':"url('../public/assets/bg_4.jpg')",
        'contact':"url('../public/assets/contact.webp')",
        'about':"url('../public/assets/abmo_about_us.webp')",
