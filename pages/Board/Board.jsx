...
// Dynamically import the Board component without server-side rendering
const Board = dynamic(() => import('@asseinfo/react-kanban'), { ssr: false });

const moveCard = dynamic(() => import('@asseinfo/react-kanban'), { ssr: false });
const moveColumn = dynamic(() => import('@asseinfo/react-kanban'), { ssr: false });
const removeCard = dynamic(() => import('@asseinfo/react-kanban'), { ssr: false });
const addCard = dynamic(() => import('@asseinfo/react-kanban'), { ssr: false });
