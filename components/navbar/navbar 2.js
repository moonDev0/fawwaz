...
const Navbar2 = () => {
  ...
  return (
    <div className={` z-20 w-full top-0 ${
      isScrolled ? 'fixed' : 'fixed'
    }`}>
      <div className={` z-20 h-[40pxx] ${
        isScrolled ? 'hidden' : ''     } `}>
      ...
      >
        <div className='container h-[75px] items-center bg-white flex justify-between mx-auto w-full'>
          <div className='logo'>
            <h1 className='text-[20px] ml-10 md:ml-0 font-bold'>FUTMINNA COUNSELLING UNIT</h1>
          </div>

          {/* Mobile menu icon */}
          <div
            className='lg:hidden mx-10 md:hidden cursor-pointer'
