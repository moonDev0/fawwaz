...
import pic from '../../public/assets/conselling-fund.webp'
...
const Portfolio = () => {
  return (
    <div>
        <div data-aos="fade-up" className="container lg:h-[550px] bg-[#eee] mt-10 w-full mx-auto grid grid-cols-1 md:grid-cols-2">
            <div className=' bg-counselling bg-cover bg-no-repeat bg-center hidden md:block'>
